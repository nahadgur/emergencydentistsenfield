...
export const serviceContent: Record<string, ServiceContent> = {
  ...
  'knocked-out-tooth': {
    intro: [
      'A completely knocked-out adult permanent tooth is one of the few true dental emergencies where every minute genuinely counts. The cells on the root surface that allow re-attachment to the jaw bone start dying within minutes of the tooth leaving the socket — by 60 minutes, success rates of re-implantation drop sharply; by two hours, long-term success is rare. From most Enfield postcodes you are 15–25 minutes from a network practice (often faster off-peak via the A10 or Piccadilly line corridor), so the window is workable if you act on it immediately rather than calling round.',
      'The single most important thing you can do is preserve the tooth correctly. Pick it up by the crown (the white part) — never the root. If it is dirty, rinse it briefly in milk or saliva. Do not use water — water is hypotonic relative to the cells on the root surface and damages them. Then either re-insert the tooth into the socket immediately (push gently — it should slot back in) or store it in cold milk or inside the patient\'s cheek pouch (saliva works as a transport medium). Get to a dentist within the hour.',
      'Matched Enfield dentists prioritise avulsion calls absolutely — schedule full or not, an avulsion case is fitted in. The emergency visit involves cleaning, re-implantation, splinting to adjacent teeth for 1–2 weeks, and follow-up monitoring. If the avulsion is part of broader facial trauma — significant lip laceration, suspected jaw fracture, head injury — North Middlesex A&E (N18) is the right destination first; Chase Farm is a planned-care site since the 2014 reorganisation and not the right route for acute trauma. Some re-implanted teeth survive for decades; some are lost despite perfect technique. The dentist will be honest about prognosis.',
    ],
    benefits: [
      {
    ...
    candidates: [
      ...
      'You are able to reach an Enfield dental practice within 1–2 hours of the injury',
    ...
    process: [
      ...
      },
      {
        ...
        desc: 'Avulsion calls bypass routine queueing. We aim to confirm an Enfield practice within 15 minutes during opening hours, factoring travel time from your specific postcode (Cockfosters/Hadley Wood routes north, Edmonton/Ponders End routes inward).',
      },
      {
  ...
  'broken-or-chipped-tooth': {
    intro: [
      ...
      'Matched Enfield dentists triage by severity, not by what would generate the highest invoice. Visible pulp exposure or significant pain books same day. Sensitivity without visible pulp exposure books within 48 hours. Cosmetic chips with no symptoms book at the next routine slot. The borough\'s patient mix — heavy on long-tenured NHS-list patients in Edmonton/Ponders End and on private-cover patients in Cockfosters/Southgate — means the same fracture sometimes leads to different appropriate treatment paths (composite vs crown) based on what is realistic for the patient. The matched dentist explains the cost trade-off honestly. Where you can recover the broken fragment, bring it — for larger front-tooth fractures, modern adhesive dentistry can sometimes re-attach the original piece for a virtually invisible repair.',
    ],
    benefits: [
      {
  ...
  'lost-filling-or-crown': {
    intro: [
      ...
      'Lost fillings vary by what was filling. A small composite repair from a routine appointment can usually be replaced like-for-like. A large amalgam filling (silver-coloured, mercury-based) that has held a tooth together for two decades is more interesting — Enfield has a high prevalence of legacy amalgam in patients who joined NHS lists in the 80s and 90s and stayed loyal to the same practice. When one of those large amalgams comes out, it has often been the only thing preserving structural integrity, and the realistic next step is a crown or sometimes an extraction rather than another filling. The matched dentist assesses the remaining structure honestly and prices both the immediate quick fix and the longer-term restoration so you can make the call.',
    ],
    benefits: [
      {
  ...
  'out-of-hours': {
    ...
    benefits: [
      ...
      {
        title: 'Saturday slots across the borough',
        desc: 'Network practices offering Saturday morning emergency slots cluster around Enfield Town, Cockfosters and Southgate. We know which are open this weekend and book directly — no calling round closed practices on a Saturday morning.',
      },
      {
  ...
  'wisdom-tooth-pain': {
    intro: [
      ...
      'Treatment for acute pericoronitis combines local cleaning under the flap (sometimes with the dentist using a syringe to irrigate trapped debris out), antibiotics if there is established infection or systemic upset, and clear advice on whether the underlying tooth should ultimately be removed. NICE guidance on wisdom-tooth removal is more conservative than common practice — extraction is recommended only where there are clear clinical indications (repeated infections, decay that cannot be restored, cysts, damage to adjacent teeth), not as routine prevention.',
      'Matched Enfield dentists triage wisdom-tooth pain by severity and frequency. A first episode of mild pericoronitis with no swelling can often be managed with home measures (warm salt-water rinses, ibuprofen, soft food) for 24–48 hours before needing a clinic visit. Severe swelling, systemic upset, repeated episodes, or any difficulty swallowing requires same-day attention — the last of those being an early warning sign of spreading infection that may need maxillofacial input at North Middlesex (N18). Where extraction is genuinely needed and the case is impacted or near the inferior alveolar nerve, the matched dentist refers to a specialist oral surgeon — typically the maxfax department at North Mid for NHS pathway, or one of the private oral surgery practices in Hampstead/Wimpole Street for private pathway.',
    ],
    benefits: [
      {
